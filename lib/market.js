...
exports.getOptionChains = function(params, token, callback)
{
    //
...
exports.getOptionExpireDates = function(underlier, token, callback)
{
    //
    // From the etrade dev portal at
	...
	this._run(actionDescriptor, {underlier:underlier}, token, callback);
};

exports.lookupProduct = function(params, token, callback)
{
    //
    // From the etrade dev portal at
...
exports.getQuote = function(params, token, callback)
{
    //
    // From the etrade dev portal at
