...
exports.listAccounts = function(token, callback)
{
    ...
    this._run(actionDescriptor, token, callback);
};

exports.getAccountBalance = function(accountId, token, callback)
{
    if (typeof(token) === 'function') {
        callback = token;
        token = '';
    ...
    var actionDescriptor = {
            method : "GET",
            module : "accounts",
            action : String(accountId) + "/balance",
            useJSON: true,
    };
    const params = {"instType": "BROKERAGE", "realTimeNAV": true}
    this._run(actionDescriptor, params, token, callback);
};

exports.getAccountPositions = function(params, token, callback)
{
    //
    // From the etrade dev portal at
    ...
    var actionDescriptor = {
            method : "GET",
            module : "accounts",
            action : params.accountIdKey + "/portfolio",
            useJSON: true,
    };
...
exports.getTransactionHistory = function(params, token, callback)
{
    //
    // From the etrade dev portal at
...
exports.getTransactionDetails = function(params, token, callback)
{
    //
    // From the etrade dev portal at
...
exports.listAlerts = function(token, callback)
{
    //
    // From the etrade dev portal at
...
exports.getAlert = function(alertId, token, callback)
{
    //
    // From the etrade dev portal at
...
exports.deleteAlert = function(alertId, token, callback)
{
    //
    // From the etrade dev portal at
