...
exports.getAccessToken = function(verificationCode, successCallback, errorCallback)
{
    ...
    this.request(requestOptions,function(error,message,body)
    {
        ...
        else
        {
            ...
            if (!this.configuration.multi_user) {
...
exports.renewAccessToken = function(accessToken, accessTokenSecret, callback)
{
    // One of successCallback or errorCallback is invoked
    ...
    // failure, if any
    if (arguments.length != 3)
        errorCallback("Invalid invocation of etrade::renewAccessToken(): Three arguments are required");
    else if (typeof(callback) != "function")
        throw ("Invalid invocation of etrade::renewAccessToken(): Callback required");
    ...
    // Add this call's query parameters
    requestOptions.qs.oauth_token = this.configuration.oauth.access_token || accessToken;

    // Sign the request
    var oauth_signature = this.oauth_sign.hmacsign(requestOptions.method,requestOptions.url,
                                              requestOptions.qs,
                                              this.configuration.secret,
                                              this.configuration.oauth.access_token_secret || accessTokenSecret);
...
exports.revokeAccessToken = function(accessToken, accessTokenSecret, callback)
{
    // One of successCallback or errorCallback is invoked
    // successCallback is invoked with no arguments on success
    //
    ...
    // failure, if any
    if (arguments.length != 3)
        callback("Invalid invocation of etrade::revokeAccessToken(): Three arguments are required");
    else if (typeof(callback) != "function")
        throw "Invalid invocation of etrade::revokeAccessToken(): Callback required";
