...
exports.listOrders = function(accountIdKey, token, callback)
{
    //
    ...
    var validationResult = this._validateAsString(accountIdKey);
    if (!validationResult.valid)
        return errorCallback("The accountIdKey parameter is invalid");

    var actionDescriptor = {
            method : "GET",
            module : "accounts",
            action : String(accountIdKey) + "/orders",
            useJSON: true,
    };
...
exports.previewEquityOrder = function(params, token, callback)
{
    //
    // From the etrade dev portal at
    ...
    var actionDescriptor = {
            method : "POST",
            module : "accounts",
            action : String(params.accountIdKey) + "/orders/preview",
            useJSON: true,
    };

    const newParms = Object.assign({}, params)
    delete newParms.accountIdKey;
    delete newParms.accountId;
    delete newParms.clientOrderId;

    var wrappedParams = { PreviewOrderRequest : {orderType: 'EQ', clientOrderId: params.clientOrderId, Order: [newParms] }};

    this._run(actionDescriptor, wrappedParams, token, callback);
};

exports.placeEquityOrder = function(params, token, callback)
{
    //
    // From the etrade dev portal at
    ...
    var actionDescriptor = {
            method : "POST",
            module : "accounts",
            action : String(params.accountIdKey) + "/orders/place",
            useJSON: true,
    };
    ...
    delete newParms.accountId;
    delete newParms.clientOrderId;
    delete newParms.previewId;

    var wrappedParams = { PlaceOrderRequest : {
        orderType: 'EQ',
...
exports.previewEquityOrderChange = function(params, token, callback)
{
    //
    // From the etrade dev portal at
    ...
    const xmlText = `
        <PreviewOrderRequest>
           ...
           <Order>
              ...
              <priceType>${params.priceType}</priceType>
              <orderTerm>${params.orderTerm}</orderTerm>
              <marketSession>REGULAR</marketSession>
              <stopPrice />
              <limitPrice>${params.limitPrice}</limitPrice>
              <Instrument>
                 <Product>
                    <securityType>EQ</securityType>
                    <symbol>${params.symbol}</symbol>
                 </Product>
                 <orderAction>${params.orderAction}</orderAction>
    ...
    this._run(actionDescriptor, xmlText, token, callback);
};

exports.placeEquityOrderChange = function(params, token, callback)
{
    //
    // From the etrade dev portal at
...
exports.previewOptionOrder = function(params, token, callback)
{
    if (typeof(token) === 'function') {
        callback = token;
        token = '';
...
exports.placeOptionOrder = function(params, token, callback)
{
    if (typeof(token) === 'function') {
        callback = token;
        token = '';
...
exports.previewOptionOrderChange = function(params, token, callback)
{
    if (typeof(token) === 'function') {
        callback = token;
        token = '';
...
exports.placeOptionOrderChange = function(params, token, callback)
{
    if (typeof(token) === 'function') {
        callback = token;
        token = '';
...
exports.cancelOrder = function(params, token, callback)
{
    if (typeof(token) === 'function') {
        callback = token;
        token = '';
    ...
    if (!this.cancelOrderDescriptor)
    {
        this.cancelOrderDescriptor = this._buildParamsDescriptor([
            "orderId",true,this._validateAsInt.bind(this)
        ]);
    }
    ...
    var actionDescriptor = {
            method : "POST",
            module : "accounts",
            action : String(params.accountIdKey) + "/orders/cancel",
            useJSON: true,
    };


    var wrappedParams = { PreviewOrderRequest : {orderId: params.orderId }};
